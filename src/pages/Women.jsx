...
import firstp from "../assets/womenpone.webp";
import secondp from "../assets/womenptwo.webp";
import thirdp from "../assets/womenpthree.webp";
import fourthp from "../assets/womenpfour.webp";
import fifthp from "../assets/womenpfive.webp";
import sixthp from "../assets/womenpsix.webp";
...
const Women = () => {
  ...
  const products = [
      { id:"W1", name: "Royal Gold Premium Ring", price: "₹50,000", image: firstp },
      { id:"W2", name: "Swirling Ring", price: "₹45,500", image: secondp },
      { id:"W3", name: "Jalli Ring", price: "₹78,000", image: thirdp },
      { id:"W4", name: "Premium Gold Chain", price: "₹62,000", image: fourthp },
      { id:"W5", name: "Platinum Pendant", price: "₹84,000", image: fifthp },
      { id:"W6", name: "Premium h letter chain", price: "₹75,000", image: sixthp },
    ];

  return (
    <div className="bg-white min-h-screen py-10 px-6 md:px-16 mt-30 md:mt-20">
      <h1 className="text-2xl font-bold mb-6">Women</h1>
